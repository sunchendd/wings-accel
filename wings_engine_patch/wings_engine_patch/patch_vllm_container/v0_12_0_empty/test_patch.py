...
def patch_vllm_report_kv_cache_config():
    def _report_kv_cache_config_wrapper(wrapped, instance, args, kwargs):
        print('[Vllm Patch] vllm.v1.core.kv_cache_utils._report_kv_cache_config called')
    ...
    def _apply_patch(module):
        try:
            ...
            print(f"[Wings Engine Patch] Failed to hook vllm.v1.core.kv_cache_utils._report_kv_cache_config: {e}")
