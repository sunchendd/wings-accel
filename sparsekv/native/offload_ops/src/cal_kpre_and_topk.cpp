...
CalKpreAndTopk::CalKpreAndTopk(uint32_t layerNum, uint32_t blockSize, uint32_t maxBs,
                               uint32_t numHeads, uint32_t headSize)
...
void CalKpreAndTopk::AddCopyReq(bool needCalKpre, uint32_t layerIdx,
                               std::vector<int32_t>& locations, torch::Tensor& npuTensor)
{
    CopyInfo copyReq;
